...
class Part(Base):
    ...
    cooperation_qc_status = Column(String(20), nullable=True, index=True)
    cooperation_qc_checked_at = Column(DateTime(timezone=True), nullable=True)
    cooperation_qc_comment = Column(Text, nullable=True)
